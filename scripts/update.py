#!/usr/bin/env python3
"""Pull Trakker's Quant postings and regenerate the README tables.

Runs once a day from .github/workflows/refresh.yml. Each run:

1. fetches every Quant intern/new-grad posting Trakker considers new in the
...
def fetch() -> list[dict]:
    ...
    request = urllib.request.Request(url, headers={
        ...
        "User-Agent": "trakker-quant-jobs/1.0 (+https://github.com/TrakkerHQ/quant-jobs)",
    })
    try:
